...
class MainFrame : JFrame() {
    ...
    private fun settings() {
        // Theme
        val themes =
            arrayOf(Theme.JCONTACTS_LIGHT, Theme.JCONTACTS_GRAY, Theme.JCONTACTS_DARK, Theme.LIGHT, Theme.DARK, Theme.INTELLIJ, Theme.DARCULA, Theme.MAC_LIGHT, Theme.MAC_DARK)
        val themeBox = JComboBox(arrayOf("JContacts Light", "JContacts Gray", "JContacts Dark", "Light", "Dark", "IntelliJ", "Darcula", "Mac Light", "Mac Dark"))
