...
class MainFrame : JFrame() {
    ...
    private fun settings() {
        // Theme
        val themes = arrayOf(Theme.JCONTACTS_DARK, Theme.JCONTACTS_LIGHT, Theme.LIGHT, Theme.DARK, Theme.INTELLIJ, Theme.DARCULA, Theme.MAC_LIGHT, Theme.MAC_DARK)
        val themeBox = JComboBox(arrayOf("JContacts Dark", "JContacts Light", "Light", "Dark", "IntelliJ", "Darcula", "Mac Light", "Mac Dark"))
